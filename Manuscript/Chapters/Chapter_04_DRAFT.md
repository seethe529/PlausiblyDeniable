...
**Status:** Not Started
**POV:** First person
**Timeline:** March 7 – April 12, 2023

---

## Chapter Goal
The five weeks. Being processed by a system that had already decided what you were. Seven nights without sleep. The one question that wouldn't stop. Two overdoses witnessed. The institution as instrument.

---

## Key Scenes / Beats
- [ ] Arrival — the first facility, seven days
- [ ] Seven nights without sleep despite medication
- [ ] The question that ran on loop: why would they want me killed
- [ ] Two overdoses witnessed
- [ ] The family conflict — not understanding what was being resigned from
- [ ] Being processed, diagnosed, discharged
...
- Cross-reference: `LeidosPsychologicalTargetingReceipt.pdf` — Sedgwick diagnosis F30.2
- Cross-reference: `Doctor_HopeSprings_Letters_Meds.pdf`
- Cross-reference: `Lingo_Master_Evidence_Timeline_v4.pdf` — March 7 – April 12, 2023 entries
